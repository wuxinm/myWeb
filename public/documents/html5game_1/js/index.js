...
//sounds
var bgm = new Audio("/documents/html5game_1/sounds/bgm.mp3");
bgm.loop = true;
bgm.volume = 0.4;
var correctSound = new Audio("/documents/html5game_1/sounds/correct.mp3");
var wrongSound = new Audio("/documents/html5game_1/sounds/wrong.mp3");
var doubleSound = new Audio("/documents/html5game_1/sounds/double.mp3");
var tripleSound = new Audio("/documents/html5game_1/sounds/triple.mp3");
var quadraSound = new Audio("/documents/html5game_1/sounds/quadra.mp3");
var pentaSound = new Audio("/documents/html5game_1/sounds/penta.mp3");
...
$(document).ready(function(){
	...
	$("#startButton").bind("click", function(){
		...
		function loadPics(){
			...
			img_back.src = '/documents/html5game_1/images/back.png';
			var img_front = new Image();
			img_front.src = '/documents/html5game_1/images/' + (index) + '.png';
